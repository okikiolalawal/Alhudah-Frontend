    ...
    <Box height="100vh" overflow="hidden">
      ...
      <div className="d-flex" style={{ height: "100vh", overflow: "hidden" }}>
        ...
        >
          ...
          {filterResults && filterResults.presentDates && filterResults.presentDates.length > 0 ? (
            <Box mt={6}>
              ...
              <Box mt={4}>
                <Heading size="sm">
                  Total Present: {filterResults.totalPresent} | Total Absent: {filterResults.totalAbsent}
                </Heading>
                <Heading size="sm">Total School Days: {filterResults.totalSchoolDays}</Heading>
              </Box>
            </Box>
          ) : (
